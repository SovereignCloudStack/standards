...
| [Artcodix](https://artcodix.de.)                                                                               | Public cloud for customers                        | artcodix UG                   | ![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/SovereignCloudStack/standards/check-qrtcodix-v3.yml?label=compliant)  | [HM](https://ohm.muc.cloud.cnds.io/)                                                                                     |
